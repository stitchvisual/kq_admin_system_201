...
export function ThemeToggle() {
  ...
  return (
    ...
    >
      ...
      <span className="absolute inset-0 rounded-full bg-primary/20 opacity-0 transition-opacity duration-200 group-hover:opacity-100" />
      ...
      <span className="absolute -inset-0.5 rounded-full border-2 border-transparent opacity-0 transition-opacity duration-200 group-focus-visible:opacity-100 group-focus-visible:border-primary/30" />
    </button>
  )
}
